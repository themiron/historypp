...
rem %UPXPATH% --force --best --all-methods --crp-ms=999999 --no-backup --overlay=copy --compress-exports=0 --compress-resources=0 --strip-relocs=0 historypp.dll
rem if errorlevel 1 goto upxerr
