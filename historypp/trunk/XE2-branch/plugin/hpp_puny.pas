...
type
  ...
  private
    ...
    function IsBasic(c: String; const n: Longint): Boolean;
    ...
    function AscW(s: String): Longint;
    function PosRev(sub, text: String): Longint;
  public
...
function TPunyClass.Encode(input: String): String;
var
...
function TPunyClass.Decode(input: String): String;
var
...
begin
  ...
  try
    ...
    begin
      ...
      if IsBasic(Char(n), INITIAL_N) = True then
      begin
        Result := '';
        Exit;
      end;
...
function TPunyClass.IsBasic(c: String; const n: Longint): Boolean;
begin
  Result := False;
...
function TPunyClass.Asc(s: String): Longint;
var
  c: Char;
begin
  Result := 0;
...
function TPunyClass.AscW(s: String): Longint;
var
  c: Char;
begin
  Result := 0;
...
function TPunyClass.PosRev(sub, text: String): Longint;
var
  p: Longint;
  s: String;
