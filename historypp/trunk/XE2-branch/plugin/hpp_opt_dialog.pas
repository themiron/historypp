...
begin
  case idCtrl of
    ID_LOOK_FONT_LINK  : st:=URL_FONTSERVICE;
    ID_LOOK_ICO_LINK   : st:=URL_ICOLIB;
    ID_LOOK_INFO_LINK  : st:=URL_EXPLAIN;
    ID_NEEDOPTIONS_LINK: st:=URL_NEEDOPTIONS;
  else
  ...
  PluginLink.CallService(MS_UTILS_OPENURL,WPARAM(True),LPARAM(PAnsiChar(AnsiString(st))));
  Result := 1;
end;
