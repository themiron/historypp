...
type
  ...
  private
    FDummyPasswordChar: AnsiChar;
    function GetPasswordChar: AnsiChar;
  protected
    procedure CreateParams(var Params: TCreateParams); override;
  published
    property PasswordChar: AnsiChar read GetPasswordChar write FDummyPasswordChar default #0;
  end;
...
function TPasswordEdit.GetPasswordChar: AnsiChar;
begin
  Result := #0;
end;
